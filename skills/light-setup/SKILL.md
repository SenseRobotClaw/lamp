---
name: light-setup
description: 控制元萝卜光翼灯SenseRobot Lamp：开关灯、亮度色温、音量、感应、TTS语音朗读（顺口溜/故事/儿歌等）、拍照、拍照判题批改作业。遇到台灯/光翼灯/开灯/关灯/亮度/色温/音量/拍照取图/坐姿报告/学习报告/语音朗读/播报等时使用。前置依赖：pip install paho-mqtt。
---
